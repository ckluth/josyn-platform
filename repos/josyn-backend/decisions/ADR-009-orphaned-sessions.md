# ADR-009 — Resolving Orphaned Sessions
...
- The accept/reject negotiation times out or the job rejects (ADR-008).
...
`JOSYN.Backend.SessionStarter` and referenced in ADR-007.
...
- How does impersonation (ADR-007) affect the process that performs orphan detection
