...
| JOSYN.Backend.BootstrapConfig | josyn-backend-bootstrap-config/JOSYN.Backend.BootstrapConfig/README.md | settled | component-architecture | maintainer-developer | Explains the runtime configuration contract used by backend components. |
...
| Name | Path | State | Type | Perspective | Summary |
|------|------|-------|------|-------------|---------|
| josyn-job-host | README.md | settled | overview | maintainer-developer, job-developer | Root overview of the josyn-job-host repo — the NuGet library linked by every JOSYN job executable. |
